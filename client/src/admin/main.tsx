...
async function fetchJson(path: string): Promise<any> {
  ...
  if (!contentType.toLowerCase().includes("application/json")) {
    throw new Error("Resposta do backend não e JSON.");
  }
...
function AdminApp() {
  ...
  return (
    <main className="min-h-screen bg-[#07100d] text-slate-100">
        ...
        <div className="mx-auto flex max-w-7xl flex-col gap-4 px-5 py-4 lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <p className="text-sm text-slate-400">
              Organização do banco, uso por usuário, arquivos locais e acervo CBERS/WMS.
            </p>
          </div>
          <button
      ...
      <section className="mx-auto grid max-w-7xl gap-4 px-5 py-5 lg:grid-cols-4">
        <MetricCard
      ...
      <section className="mx-auto grid max-w-7xl gap-4 px-5 pb-5 xl:grid-cols-[1fr_1.2fr]">
        <ChartPanel
      ...
      <section className="mx-auto grid max-w-7xl gap-4 px-5 pb-5 xl:grid-cols-2">
        <ChartPanel
