...
import {
  ...
  StartOraculoPipelineArgs,
  StartedOraculoPipeline,
  TERMINAL_STATUSES,
  dependencies,
  eventAt,
  createArtifact,
  ...
  ErrorSummary,
  AutofixPhase,
  FixPlanArtifactPayload,
  AutofixDecision,
  totalErrors,
  actionSignature,
} from "./pipeline-support";

// Tipos públicos do pipeline continuam exportados por este módulo (plano 07).
export type {
  OraculoPipelineNotification,
  OraculoPipelineDependencies,
  StartOraculoPipelineArgs,
  StartedOraculoPipeline,
} from "./pipeline-support";
